...
Update `docker-compose.yml` to allow secrets-fetcher to access host network:
...
Note: Current host launcher flow uses in-memory env injection and does not require writing `opencode-secrets.env` locally.
